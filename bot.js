...
client.on("message", message => {
 ...
 if (message.content === "*help") {
  ...
  const embed = new Discord.RichEmbed()
      ...
      .addField("『*help A』『اذا تبي جميع الاوامر مع اوامر اضافية』", true)
      
	    .addField("『*help P』『اذا تبي الاوامر العامة』", true)
	    
      .addField("『*help AD』『اذا تبي  الاوامر الادارية』", true)
...
'*** انا لست الحوت الازرق كما يدعون ***',
   ...
   '*** ان لم تحصل عليه , اكتب .م��يم مرة اخرى ***',
...
const secreT = [
  ...
  "**لا تحزن على من اشعرك بان طيبتك غباء ��مام وقاحته**.",
...
client.on('message', message => {
 if (message.content.startsWith("ترحيب 2")) {
  ...
  .setThumbnail(`${mentionavatar.avatarURL}`)
  .addField("***شكرا الانضمامك الينا***" ,mentionavatar.username )
  .setDescription('***هلا باللي ملك قلبي هل�� باللي فداه الروح هلا باللي شغل فكري هلا باللي هواه البوح.***')
...
client.on('message', message => {
 if (message.content.startsWith("ترحيب 6")) {
  ...
  .setThumbnail(`${mentionavatar.avatarURL}`)
  .addField("***شكرا الانضمامك الينا***" ,mentionavatar.username )
  .setDescription('***مرحبا بك كثر النجوم الساطعة وكثر الورود الفائحة ال��ي تفوح بأزكى العطور وكثر ما تكتب الأقلام من الحروف والعبارات. ***')
